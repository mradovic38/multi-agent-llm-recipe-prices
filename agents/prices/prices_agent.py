...
class PricesAgent():
    ...
    prompt_path='multi-agent-llm-recipe-prices/agents/prices/prompts/prices_prompt.txt', ingredients_tag='<ingredients>', conditions_tag='<conditions>') -> None:
    ...
    def get_prices(self, ingredients: List[Ingredient], conditions: List[str] = []):
        ...
        return self._get_top_articles_and_total_price(result)
